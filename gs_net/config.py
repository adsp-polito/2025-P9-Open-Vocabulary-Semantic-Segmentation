...
def add_cat_seg_config(cfg):
    ...
    cfg.MODEL.SEM_SEG_HEAD.USE_CLIP_CORR = True 
    cfg.MODEL.SEM_SEG_HEAD.USE_DINO_CORR = True 
    cfg.MODEL.SEM_SEG_HEAD.FUSION_TYPE = "query_guided" 
    cfg.MODEL.SEM_SEG_HEAD.DECODER_DIMS = [128,64] 
    cfg.MODEL.SEM_SEG_HEAD.DECODER_CLIP_GUIDANCE_DIMS = [0,0] 
    cfg.MODEL.SEM_SEG_HEAD.DECODER_CLIP_GUIDANCE_PROJ_DIMS = [0,0] 
    cfg.MODEL.SEM_SEG_HEAD.DECODER_DINO_GUIDANCE_DIMS = [256,128] 
    cfg.MODEL.SEM_SEG_HEAD.DECODER_DINO_GUIDANCE_PROJ_DIMS = [32,16] 
    cfg.MODEL.SEM_SEG_HEAD.CLIP_PRETRAINED = "ViT-B/16"
    cfg.MODEL.SEM_SEG_HEAD.DINO_FINETUNE = "attention"
    cfg.MODEL.SEM_SEG_HEAD.DINO_WEIGHTS = ""
